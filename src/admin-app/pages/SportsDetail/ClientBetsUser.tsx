...
const ClientBetsUser = () => {
  ...
  React.useEffect(() => {
    accountService.matchdetail2(maid).then((res: AxiosResponse) => {
      ...
      //console.log(maid, "match id from param");
      ...
      //console.log(bmbetf, "book aker bets fancy");
